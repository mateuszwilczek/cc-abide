...
# PCP summary containing FILE_ID
PCP_summary <- read.csv("data/pcp/summary.csv")

# write FILE_ID to a file for bash script input
write(PCP_summary$FILE_ID, file="./data/pcp/FILE_ID.txt")
...
rm (file1_table, file, files, file_id, file_table, i, row, col, aseg.csv_path,
    ASEG_StructName_measure, ASEG_cols, meas, struct)
...
# export/import A df with matched pairs
